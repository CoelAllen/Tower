<template>
  <span class="navbar-text">
    ...
    <div class="dropdown my-2 my-lg-0" v-else>
      <div class="text-center dropdown-toggle selectable" data-bs-toggle="dropdown" aria-expanded="false"
        id="authDropdown">
        ...
        <span class="mt-3 pt-3 text-success lighten-30">{{ account.name || user.name }}</span>
      </div>
